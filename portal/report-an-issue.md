...
>tip The **Fiddler Jam Embedded** is a dedicated API that you can use alongside your unique API key to fully integrate the Fiddler Jam logging and submission services into your site. If you want more information on acquiring the **Fiddler Jam Embedded** API key and how to use the API, don't hesitate to contact us at support@getfiddler.com.
