...
<p>Welcome to the GitHub repo for <a href="http://www.telerik.com/fiddler-jam-docs">Fiddler Jam</a> <a href="#">Documentation</a>. This repository contains the source content--written in Markdown--that we use to power the Fiddler Jam Documentation at <a href="http://www.telerik.com/fiddler-jam">https://www.telerik.com/fiddler-jam</a>.
...
<p>Once you've read these--or you've already memorized them--you're ready to contribute to the Fiddler Jam docs. Start by creating a local clone of our repo either using <a href="http://windows.github.com/">GitHub for Windows</a>, <a href="http://mac.github.com/">GitHub for Mac</a> or your friendly command-line:</p>

<pre><code>git clone git@github.com:telerik/fiddler-jam-docs.git
</code></pre>

<p>Then, open up the fiddler-jam-docs folder in your favorite text editor and contribute away! Of course, as you work with the docs, we do ask that you follow a couple of ground rules:</p>
...
<hr>
<p>title: Add stuff to Fiddler Jam</p>
...
<p>Once you've made your changes, commit, pull, merge, push, and <a href="https://help.github.com/articles/using-pull-requests">send us a pull request</a>! We--and Fiddler Jam users everywhere--thank you for making our docs better! </p>
</li>
</ul></article>