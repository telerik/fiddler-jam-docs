...
4. The Google Chrome browser wiil inform you via a cancalable prompt that states **_“’Fiddler Jam’ started debugging the browser”_.** To proceed with capturing simply close the notification. Note that clicking on **_Cancel_** with reset the Fiddler Jam state, effectively stoping the capturing session.
