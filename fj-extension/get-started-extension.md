...
1. Click the ![Extension main icon](../images/ext/ext-icons/small-logo.png) extension icon to launch the Fiddler Jam extension. Alternatively, use the keyboard shortcut **Ctrl* + **Shift** + **H**.
